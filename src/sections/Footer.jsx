    ...
    <footer>
      <div className="min-h-[100px] flex flex-col justify-center gap-6 text-center text-lg text-gray-300 font-mono mb-10 ">
        <div className="flex gap-10 p-4 justify-center text-white ">
          <a
            href="https://www.linkedin.com/in/ashish-akteri-26a53521a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
          ...
          <a
            href="https://github.com/ash180403"
        ...
        <p>@ 2025 ashishakteri18@gmail.com. All rights reserved. </p>
      </div>
    </footer>
  );
}
